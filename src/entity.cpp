...
bool entity::collides_with(const entity &e) const {
...
//collision shit
bool entity::going_to_go_offscreen_x(const bn::fixed_rect &new_hitbox) const {
...
bool entity::going_to_go_offscreen_y(const bn::fixed_rect &new_hitbox) const {
...
bool entity::going_to_collide_x(const bn::fixed &new_x, 
...
bool entity::going_to_collide_y(const bn::fixed &new_y, 
    const bn::fixed_rect &box) const {
    bn::fixed_rect new_hitbox=_hitbox;
